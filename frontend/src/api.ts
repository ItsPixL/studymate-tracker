...
export async function addSubject(
  ...
  const res = await fetch("http://localhost:8000/api/addSubject", {
    method: "POST",
    headers: {
...
export async function removeSubject(
  ...
  const res = await fetch("http://localhost:8000/api/removeSubject", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function checkSubject(
  subjectName: string
): Promise<{ res: boolean }> {
  const res = await fetch("http://localhost:8000/api/checkSubject", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function logSession(
  ...
  const res = await fetch("http://localhost:8000/api/logSession", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
